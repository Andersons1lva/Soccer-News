...
* ViewModels e camada de acesso a dados. Entretanto, apesar das nossas camadas ficarem mais coesas, o idel seria usar uma solução de
* injeção de dependências (como Dagger ou o Hilt).
*
